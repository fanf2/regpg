...
\notes{
  ...
  \regpg has made a public key ring (and a backup file, because \gpg
  loves backup files)
  ...
  One bit of magic going on here is that \regpg ensures that \gpg uses
  the backwards compatible keyring format, even if you are using \gpg
  2.1.
...
\notes{
  ...
  There's an example of how to use this setup at the end of the \regpg
  man page.
